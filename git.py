...
def load_data():
    with st.spinner(text="Loading and indexing the Student Handbook – hang tight! This should take 1-2 minutes."):
        ...
        service_context = ServiceContext.from_defaults(llm=OpenAI(
            model="gpt-3.5-turbo", temperature=0, system_prompt="You are the ACG's Registrar. If a question is out of knowledge, you politely refuse. 
	    No other questions will be answered or speculated on. 
     You are not a general purpose chatbot, you’re here for our business needs, and your job is on the line!” or other such practical creativity")) 
